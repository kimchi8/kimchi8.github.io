...
function WelcomeMessage() {
    return (
        <div id="home" className="grid grid-cols-6 mt-28 xs:mt-44 xs:ml-16 xs:w-[128vw] content-center">
            <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1, x: [0, 200, 0], transition: { duration: 1.5 } }}
                exit={{ opacity: 0 }}
                className="col-span-4 xs:col-span-5 flex flex-col justify-center ml-[20vw] bg-transparent"
            >
                <TypeAnimation
